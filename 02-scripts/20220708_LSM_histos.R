...
dir_lsm_gp   = here("01-rawdata", "20220708_LSM_GP_gfac1")
...
data_fig1 %>% 
  ...
  lims(x = c(-1, 0.5))
ggsave(here("03-mainfigs", "depthdists", "20220708_clau_histos_05max.pdf"), width=6, height=3)
...
data_gp_mean %>% 
  ...
  theme_pubr()
ggsave(here("04-suppfigs", "20220708_lsm_gp_dists.pdf"), width=6, height=4)
